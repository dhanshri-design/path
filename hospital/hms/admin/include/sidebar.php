							...
							<!--li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Docator</span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="daily-invoice.php">
											<span class="title"> Daily Invoice</span>
										</a>
									</li>
									<li>
										<a href="monthly-invoice.php">
											<span class="title"> Monthly Invoice</span>
										</a>
									</li>
									<li>
										<a href="yearly-invoice.php">
											<span class="title"> Yearly Invoice</span>
										</a>
									</li>
								</ul>
							</li>	
